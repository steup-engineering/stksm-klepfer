...
public class GuiOutBevel {
    ...
    private final GuiOutStation motors[] = new GuiOutStation[Main.BEVEL_MOTOR_COUNT];
    ...
    public void update(GuiOutBevel src) {
        ...
        GuiOutStation.update(motors, src.motors);
    }
    ...
    public GuiOutStation[] getMotors() {
        return motors;
    }
